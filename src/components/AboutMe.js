...
function AboutMe() {
    return ( <
        div id = "aboutme" > { /* hero */ } <
        div class = "hero bg-gray-100 py-16" > { /* container */ } <
        div class = "container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto" > { /* hero wrapper */ } <
        ...
        <
        img class = "floating md:mt-0 rounded-full w-40 shadow-sm ml-auto mr-auto "
        ...
        div class = "lg:w-1/2" >
        <
        div class = "h-64 bg-cover lg:rounded-lg lg:h-full __aboutHeroImg" /
        >
        <
        /div> <
        ...
        I have a passion
        for creating clean, polished UI designs using HTML, CSS, & JavaScript, keeping user functionality in mind. <
        /p> <
        ...
        San Diego based Full Stack Developer who speecializes in building & designing digital experience. <
        /p> <
        /div> <
        /div> <
        /div> <
